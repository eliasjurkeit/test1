...
function init() {
    ...
    const hdrEquirect = new RGBELoader().load("https://raw.githubusercontent.com/eliasjurkeit/test1/lavatext/assets/empty_warehouse_01_2k.hdr", () => {
    ...
    const normalMapTexture = textureLoader.load("https://raw.githubusercontent.com/eliasjurkeit/test1/lavatext/assets/normal.jpg", () => {
    }, undefined, (error) => {
        console.error(error);
    });
